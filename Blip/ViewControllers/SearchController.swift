...
class SearchController: YNSearchViewController, YNSearchDelegate{
    ...
    func ynSearchHistoryButtonClicked(text: String) {
        ...
        print("ynSearchHistoryButtonClicked:", text)
    }
    
    func ynCategoryButtonClicked(text: String) {
        self.pushViewController(text: text)
        print("ynCategoryButtonClicked",text)
    }
    
    func ynSearchListViewClicked(key: String) {
        self.pushViewController(text: key)
        print("ynSearchListViewClicked",key)
    }
    
    func ynSearchListViewClicked(object: Any) {
        print("ynSearchListViewClicked", object)
    }
